<x-app-layout>
    ...
    <section class=" dark:bg-gray-900">
        <div class="bg-white py-16 px-4 mx-auto max-w-2xl lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Apply Loan</h2>
