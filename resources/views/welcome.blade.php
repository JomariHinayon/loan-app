    ...
    <body class="antialiased">
            ...
            <div class="container mx-auto">
                ...
                <div id="hero-section__bg" class="grid grid-cols-2 p-16">
                    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">A new lending experience, Quick and Easy Approval</p>
                        ...
                        <div class="py-5 font-semibold">
                            <p class="text-2xl font-bolder">₱50,000</p>
                        </div>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 pt-2 pb-3">Personal loan from PHP5,000 up to PHP50,000</p>
                        <div>
                            <button id="dropdownDelayButton" data-dropdown-toggle="dropdownDelay" data-dropdown-delay="500" data-dropdown-trigger="hover" class="text-black bg-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center w-[35%]" type="button">Choose Months <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                ...
                <section>
                    <div class="p-16">
                        <div class=" text-center w-100 mb-24">
                            <h1 class="text-gray-800 text-center text-4xl font-bold">How To Apply For A Loan</h1>
                        </div>
                        <div class="grid grid-cols-4 gap-10">
                            ...
                            <img src="https://cdn.vamo.ph/assets/uploads/icon-apply-1.svg" alt="" class="w-[70px]">
                                <div>
                                    <h5 class="mb-2 text-2xl font-semibold text-gray-500 py-5">Register</h5>
                                </div>
                                <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Fill out the application and confirm submission by OTP (one-time password)</p>
                            </div>

                            <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col items-center">
                                <img src="https://cdn.vamo.ph/assets/uploads/icon-apply-2.svg" alt="" class="w-[50px]">
                                <div class="text-center">
                                    <h5 class="mb-2 text-2xl font-semibold text-gray-500 py-5">Await the confirmation</h5>
                                </div>
                                <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">You may receive a call from our customer service representative</p>
                            </div>

                            <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col items-center">
                            <img src="https://cdn.vamo.ph/assets/uploads/icon-apply-3.svg" alt="" class="w-[60px]">                               
                            <div class="text-center">
                                    <h5 class="mb-2 text-2xl font-semibold text-gray-500 py-5">Withdraw the approved credit</h5>
                                </div>
                                <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Funds will be transferred to your bank account or e-wallet</p>
                            </div>

                            <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col items-center">
                                <img src="https://cdn.vamo.ph/assets/uploads/icon-apply-4.svg" alt="" class="w-[60px]">
                            <div class="text-center">
                                        <h5 class="mb-2 text-2xl font-semibold text-gray-500 py-5">Flexible repayment options</h5>
                                    </div>
                                    <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Choose to repay loan entirely anytime or pay back by minimum monthly payments</p>
                                </div>
            ...
            <ul role="list" class="grid gap-x-8 gap-y-12 sm:grid-cols-2 sm:gap-y-16 xl:col-span-2">
              <li>
                <div class="flex items-center gap-x-6">
                  <img class="h-16 w-16 rounded-full" src="/images/luisa_bautista.jpg" alt="">
                  <div>
                    <h3 class="text-base font-semibold leading-7 tracking-tight text-gray-900">Luisa Bautista</h3>
                    <p class="text-sm font-semibold leading-6 text-indigo-600">Co-Founder / Leader</p>
                  </div>
                </div>
              </li>
              ...
              <li>
                <div class="flex items-center gap-x-6">
                  <img class="h-16 w-16 rounded-full" src="/images/jomari_hinayon.jpg" alt="">
                  <div>
                    <h3 class="text-base font-semibold leading-7 tracking-tight text-gray-900">Jomari Hinayon</h3>
                    <p class="text-sm font-semibold leading-6 text-indigo-600">Senior Programmer</p>
                  </div>
                </div>
              </li>
              ...
              <li>
                <div class="flex items-center gap-x-6">
                  <img class="h-16 w-16 rounded-full" src="/images/kyle_manipon.jpg" alt="">
                  <div>
                    <h3 class="text-base font-semibold leading-7 tracking-tight text-gray-900">Kyle Yvann Rae Manipon</h3>
                    <p class="text-sm font-semibold leading-6 text-indigo-600">Project Manager / web design</p>
                  </div>
                </div>
              </li>
              ...
              <li>
                <div class="flex items-center gap-x-6">
                  ...
                  <div>
                    <h3 class="text-base font-semibold leading-7 tracking-tight text-gray-900">Karen Corde</h3>
                    <p class="text-sm font-semibold leading-6 text-indigo-600">Researcher</p>
                  </div>
                </div>
              </li>
              ...
              <li>
                <div class="flex items-center gap-x-6">
                  <img class="h-16 w-16 rounded-full" src="/images/daniel_pore.jpg" alt="">
                  <div>
                    <h3 class="text-base font-semibold leading-7 tracking-tight text-gray-900">Daniel Pore</h3>
                    <p class="text-sm font-semibold leading-6 text-indigo-600">Analyst </p>
                  </div>
                </div>
              </li>
              ...
              <li>
                <div class="flex items-center gap-x-6">
                  <img class="h-16 w-16 rounded-full" src="/images/john_gabriel.jpg" alt="">
                  <div>
                    <h3 class="text-base font-semibold leading-7 tracking-tight text-gray-900">John Gabriel</h3>
                    <p class="text-sm font-semibold leading-6 text-indigo-600">Marketing strategist</p>
                  </div>
                </div>
              </li>
              ...
              <li>
                <div class="flex items-center gap-x-6">
                  <img class="h-16 w-16 rounded-full" src="/images/akyla_crisostomo.jpg" alt="">
                  <div>
                    <h3 class="text-base font-semibold leading-7 tracking-tight text-gray-900">Akyla Crisostomo</h3>
                    <p class="text-sm font-semibold leading-6 text-indigo-600">Enumerator</p>
                  </div>
                </div>
              </li>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                // Initialize the Flowbite slider
                var mySlider = new Flowbite.Slider('#mySlider', {
                    // Additional options for the slider configuration
                });

                // Add an event listener for the 'input' event, which is fired when the slider value changes
                mySlider.on('input', function(value) {
                    // Log the current value to the console (you can use this value as needed)
