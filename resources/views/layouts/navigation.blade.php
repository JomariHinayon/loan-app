            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img class="w-20 h-12 fill-current text-gray-500"  src="/images/logo.png" alt="description of myimage">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('profile.loans')" :active="request()->routeIs('profile.loans')">
                        {{ __('Loans') }}
                    </x-nav-link> 
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
